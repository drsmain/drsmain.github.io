...
document.getElementById('notification').addEventListener("click", function () {
    ...
    document.getElementById('notification_disaster').textContent = '보고재해: ' + document.getElementById('disaster').textContent
            ...
            try {
                ...
                var embed = {
                    ...
                    "fields": [
                        {
                            "name": '신고자 ID',
                            'value': localStorage.getItem('report_id')
                        }, {
                            "name": '신고시각',
                            ...
                            "name": '보고 재해',
                            'value': (document.getElementById('disaster').textContent),
                            "inline": true
                        }, {
                            "name": '보고 상황',
